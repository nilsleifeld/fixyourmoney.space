...
! function () {
    ...
    h.WidgetAbstract.prototype = {
        ...
        widgetCode: function () {
            ...
            if (this.options.tabs) {
                p = 0;
                for (var w = this.options.tabs.length; p < w; p++) {
                    var b = this.options.tabs[p];
            ...
            var v = h.getHost(this.options) + i + "?" + e + t + o + g + r + n + s + a + d + l;
        ...
        create: function () {
            ...
            o && o.parentElement && o.parentElement.removeChild(o), this.iframe = document.getElementById(this.id), this.postMessage = h.postMessageWrapper(this.iframe.contentWindow, this.id), h.bindEvent(this.iframe, "load", (function () {
                ...
                var a = t.options.popup_width || 900,
                    ...
                    l = (screen.width - a) / 2,
                    c = (screen.height - d) / 2,
                    g = window.open(t.generateUrl(o), "_blank", "resizable=yes, top=" + c + ", left=" + l + ", width=" + a + ", height=" + d);
                g && (g.opener = null)
            }))
        },
        ready: function (e) {
    ...
    var c = function (e, t) {
        ...
        g = function (e, t) {
            for (var o in t) "object" == typeof t[o] && e.hasOwnProperty(o) ? g(e[o], t[o]) : e[o] = t[o];
            return e
        };
